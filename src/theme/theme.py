...
def theme_purple(displayer) -> None:
...
def theme_yellow(displayer) -> None:
...
def theme_green(displayer) -> None:
...
def theme_orange(displayer) -> None:
...
def theme_multicolor(displayer) -> None:
